...
QUnit.module('CookieBanner', {
	...
	afterEach: function () {
		SHARED.utils.setCookie('optcookieinfo',true,0,'/');
...
QUnit.test('Check cookie is not set before click', function (assert) {
	...
	assert.equal(SHARED.cookieBanner.isCookiePolicyAccepted(), false, "Cookie is not set before click");
...
QUnit.test('Check cookie is set after click', function (assert) {
	...
	assert.equal(SHARED.cookieBanner.isCookiePolicyAccepted(), true, "Cookie is set after click");
